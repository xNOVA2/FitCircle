...
const UserList = () => {
  ...
  return (
    <div className="flex flex-col gap-10 ">
      ...
      <UserAvatar name="12U9R" text="Lorem Ipsum is simply dummy text of..." />
      <UserAvatar name="Ali Osaid" text="Lorem Ipsum is simply dummy text of..." />
        ...
        <h1 className="font-bold text-4xl mb-2 p-5">Support</h1>
          ...
          <div className="flex-grow flex ">
            ...
            <div className="w-[45%] p-5 border-r ">
              ...
              <span>
                <Link href={"/support"} className="text-ButtonBlue font-bold">Message</Link>{" "}
                </span>
                <span>
